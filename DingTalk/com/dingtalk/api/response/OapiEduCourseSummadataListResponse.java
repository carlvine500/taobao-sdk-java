...
public class OapiEduCourseSummadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2784137129223428897L;
	...
	public static class CourseSummaryDataDTO extends TaobaoObject {
		private static final long serialVersionUID = 6529424281854273241L;
		/**
		 * 数据类别业务唯一键
		 */
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7246441988599775165L;
		/**
		 * 表示是否还有更多的数据
		 */
		@ApiField("has_more")
