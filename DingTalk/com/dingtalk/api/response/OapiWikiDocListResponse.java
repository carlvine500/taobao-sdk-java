...
public class OapiWikiDocListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4371956612854856611L;
	...
	public static class OpenDocVO extends TaobaoObject {
		private static final long serialVersionUID = 8615123644513929731L;
		/**
		 * 知识库ID（加密后的）
		 */
		@ApiField("group_id")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 6356692565511134141L;
		/**
		 * 知识页列表
		 */
		@ApiListField("data")
