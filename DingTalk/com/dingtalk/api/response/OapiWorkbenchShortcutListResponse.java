...
public class OapiWorkbenchShortcutListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8859449679779844887L;
	...
	public static class IsvOrgShortcutDTO extends TaobaoObject {
		private static final long serialVersionUID = 7113823189233123918L;
		/**
		 * 业务单号,系统间交互唯一流水号
		 */
		@ApiField("biz_no")
	...
	public static class IsvOrgShortcutListDTO extends TaobaoObject {
		private static final long serialVersionUID = 8394437134973969226L;
		/**
		 * 企业下指定应用已添加快捷方式列表
		 */
