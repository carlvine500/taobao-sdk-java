...
public class OapiAttendanceGetleavetimebynamesResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4715159561818881967L;
	...
	public static class ColumnForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 8738381828612773883L;
		/**
		 * 别名
		 */
		@ApiField("alias")
	...
	public static class ColumnDayAndVal extends TaobaoObject {
		private static final long serialVersionUID = 1456475928779362796L;
		/**
		 * 时间
		 */
		@ApiField("date")
	...
	public static class ColumnValForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 7579756349455962526L;
		/**
		 * 列值数据
		 */
	...
	public static class ColumnValListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 3888625523258986232L;
		/**
		 * 列信息与列值数据
		 */
