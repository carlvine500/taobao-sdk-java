...
public class OapiCrmObjectdataContactQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4197177684175893713L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 7236628539227912925L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class Values extends TaobaoObject {
		private static final long serialVersionUID = 7135289729958677418L;
		/**
		 * 创建记录的用户昵称
		 */
	...
	public static class IterablePage extends TaobaoObject {
		private static final long serialVersionUID = 4358633794227417582L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
