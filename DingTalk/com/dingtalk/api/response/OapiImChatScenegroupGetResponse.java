...
public class OapiImChatScenegroupGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8622145994687311569L;
	...
	public static class ManagementOptions extends TaobaoObject {
		private static final long serialVersionUID = 3274673621419833513L;
		/**
		 * 群禁言，0-默认，不禁言，1-全员禁言
		 */
	...
	public static class DecorationGroupQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 3862718998933439217L;
		/**
		 * 入群链接（需特殊申请才返回）
		 */
		@ApiField("group_url")
