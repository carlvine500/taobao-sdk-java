...
public class OapiSmartworkHrmEmployeeV2ListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8372437237652725691L;
	...
	public static class FieldValueVo extends TaobaoObject {
		private static final long serialVersionUID = 1831515296794817865L;
		/**
		 * 标识第几条明细（下标从0开始）
		 */
		@ApiField("item_index")
	...
	public static class EmpFieldDataVo extends TaobaoObject {
		private static final long serialVersionUID = 6774321892986944179L;
		/**
		 * 字段标识
		 */
		@ApiField("field_code")
	...
	public static class EmpRosterFieldVo extends TaobaoObject {
		private static final long serialVersionUID = 2318575644993611916L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
