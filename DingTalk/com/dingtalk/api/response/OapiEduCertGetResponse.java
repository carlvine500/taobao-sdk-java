...
public class OapiEduCertGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3417836224295898271L;
	...
	public static class Certdata extends TaobaoObject {
		private static final long serialVersionUID = 6115148973985754393L;
		/**
	...
	public static class OpenPracticalTaskData extends TaobaoObject {
		private static final long serialVersionUID = 6475997898427117333L;
		/**
		 * true表示完成，false表示未完成
		 */
		@ApiField("finish")
	...
	public static class OpenQueryCertResponse extends TaobaoObject {
		private static final long serialVersionUID = 5865379319118362721L;
		/**
		 * 认证明细
		 */
