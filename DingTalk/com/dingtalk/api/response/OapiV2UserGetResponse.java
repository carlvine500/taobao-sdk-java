...
public class OapiV2UserGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7192699871596763822L;
	...
	public static class DeptOrder extends TaobaoObject {
		private static final long serialVersionUID = 4826428382963441121L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class DeptLeader extends TaobaoObject {
		private static final long serialVersionUID = 4783228959419348599L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class UserRole extends TaobaoObject {
		private static final long serialVersionUID = 3193466837315214263L;
		/**
		 * 角色组名称
		 */
		@ApiField("group_name")
	...
	public static class UnionEmpMapVo extends TaobaoObject {
		private static final long serialVersionUID = 2226638273171352943L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
	...
	public static class UnionEmpExt extends TaobaoObject {
		private static final long serialVersionUID = 5846425492942437211L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
	...
	public static class UserGetResponse extends TaobaoObject {
		private static final long serialVersionUID = 2292116528757464712L;
		/**
		 * 是否激活
		 */
		@ApiField("active")
