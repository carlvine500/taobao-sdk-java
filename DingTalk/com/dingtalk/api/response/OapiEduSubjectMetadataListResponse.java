...
public class OapiEduSubjectMetadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3788977142812584948L;
	...
	public static class SubjectMetadataDTO extends TaobaoObject {
		private static final long serialVersionUID = 4685347987253651592L;
		/**
		 * 区域编码
		 */
		@ApiField("area_code")
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 6434426523279714158L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
