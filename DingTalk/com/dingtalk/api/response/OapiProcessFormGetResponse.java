...
public class OapiProcessFormGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6751282898522228982L;
	...
	public static class FormComponentStatVo extends TaobaoObject {
		private static final long serialVersionUID = 4488621762136831819L;
		/**
		 * 组件id
		 */
		@ApiField("id")
	...
	public static class LinkageTargetVo extends TaobaoObject {
		private static final long serialVersionUID = 2794875582371934462L;
		/**
		 * 对应目标的行为
		 */
		@ApiField("behavior")
	...
	public static class BehaviorLinkageVo extends TaobaoObject {
		private static final long serialVersionUID = 6158675325617545926L;
		/**
		 * 联动对应的目标
		 */
	...
	public static class FormComponentPropVo extends TaobaoObject {
		private static final long serialVersionUID = 2757358578933196794L;
		/**
		 * 考勤类型文案
		 */
	...
	public static class FormComponent2Vo extends TaobaoObject {
		private static final long serialVersionUID = 8628515356216489625L;
		/**
		 * 控件类型
		 */
	...
	public static class FormComponent1Vo extends TaobaoObject {
		private static final long serialVersionUID = 4317364177739466439L;
		/**
		 * 子组件
		 */
	...
	public static class FormComponentVo extends TaobaoObject {
		private static final long serialVersionUID = 2273636118932785793L;
		/**
		 * 子组件
		 */
		@ApiListField("children")
	...
	public static class ProcessTopVo extends TaobaoObject {
		private static final long serialVersionUID = 5177979281417928454L;
		/**
		 * 表单列表
		 */
