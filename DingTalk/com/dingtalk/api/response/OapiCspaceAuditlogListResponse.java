...
public class OapiCspaceAuditlogListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1564452696924173758L;
	...
	public static class AuditLogVO extends TaobaoObject {
		private static final long serialVersionUID = 3112454954776918876L;
		/**
		 * 操作类型
		 */
		@ApiField("action")
	...
	public static class ListAuditLogResult extends TaobaoObject {
		private static final long serialVersionUID = 7671798584553691779L;
		/**
		 * 记录列表
		 */
		@ApiListField("list")
