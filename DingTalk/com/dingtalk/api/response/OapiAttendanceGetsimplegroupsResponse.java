...
public class OapiAttendanceGetsimplegroupsResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8176864661324557574L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 1474385175523836453L;
		/**
		 * 开始时间
		 */
		@ApiField("check_time")
	...
	public static class ClassSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 7866225463923971462L;
		/**
		 * 旷工迟到时长,单位分钟
		 */
	...
	public static class SetionTimeVO extends TaobaoObject {
		private static final long serialVersionUID = 1214687291499538397L;
		/**
		 * 打卡时间跨度
		 */
		@ApiField("across")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 4513844138263537366L;
		/**
		 * 时间段列表
		 */
		@ApiListField("times")
	...
	public static class AtClassVo extends TaobaoObject {
		private static final long serialVersionUID = 6825746681629981117L;
		/**
		 * 考勤班次id
		 */
		@ApiField("class_id")
	...
	public static class AtGroupForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 1513686966335641317L;
		/**
	...
	public static class AtGroupListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 1622273391921596128L;
		/**
		 * 考勤组列表
		 */
		@ApiListField("groups")
