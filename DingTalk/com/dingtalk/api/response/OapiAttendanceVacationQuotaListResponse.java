...
public class OapiAttendanceVacationQuotaListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4718281665349779445L;
	...
	public static class Leavequotas extends TaobaoObject {
		private static final long serialVersionUID = 5877214935984182198L;
		/**
		 * 额度有效期结束时间(毫秒级时间戳)
		 */
		@ApiField("end_time")
	...
	public static class OapiLeaveQuotaUserListVo extends TaobaoObject {
		private static final long serialVersionUID = 5136768473719365571L;
		/**
		 * 是否存在更多记录
		 */
		@ApiField("has_more")
