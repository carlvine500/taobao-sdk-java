...
public class OapiAlitripBtripFlightOrderSearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3672171624438351547L;
	...
	public static class OpenInvoiceDo extends TaobaoObject {
		private static final long serialVersionUID = 8392191886266753598L;
		/**
		 * 商旅发票id
		 */
		@ApiField("id")
	...
	public static class OpenCostCenterDo extends TaobaoObject {
		private static final long serialVersionUID = 4833575394467339741L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenPriceInfo extends TaobaoObject {
		private static final long serialVersionUID = 2798912491192323378L;
		/**
		 * 交易类目
		 */
		@ApiField("category")
	...
	public static class OpenFlightInsureInfo extends TaobaoObject {
		private static final long serialVersionUID = 2294339682131457747L;
		/**
		 * 保单号
		 */
		@ApiField("insure_no")
	...
	public static class OpenUserAffiliateDo extends TaobaoObject {
		private static final long serialVersionUID = 3882994646735113939L;
		/**
		 * 出行人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenFlightOrderRs extends TaobaoObject {
		private static final long serialVersionUID = 4839431554753852915L;
		/**
		 * 商旅申请单id
		 */
		@ApiField("apply_id")
	...
	public static class PageInfoRs extends TaobaoObject {
		private static final long serialVersionUID = 4623119491773173746L;
		/**
		 * 当前页
		 */
		@ApiField("page")
