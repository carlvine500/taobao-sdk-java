...
public class OapiAttendanceGetusergroupResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1193633925534488615L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 3799331648441397967L;
		/**
		 * 打卡时间跨几天
		 */
		@ApiField("across")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 1627269929292214866L;
		/**
		 * 班次中上下班详情列表
		 */
		@ApiListField("times")
	...
	public static class ClassSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 1625154645338823335L;
		/**
		 * 休息开始时间
		 */
	...
	public static class AtClassVo extends TaobaoObject {
		private static final long serialVersionUID = 3591569141393232232L;
		/**
		 * 班次id
		 */
		@ApiField("class_id")
	...
	public static class AtGroupFullForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 5565779131725238518L;
		/**
		 * 考勤组中的班次列表
		 */
