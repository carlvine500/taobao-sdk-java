...
public class OapiCrmObjectmetaContactDescribeResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7112682442447954381L;
	...
	public static class SelectOptions extends TaobaoObject {
		private static final long serialVersionUID = 1328284199832147542L;
		/**
		 * 选项key
		 */
		@ApiField("key")
	...
	public static class ReferenceFields extends TaobaoObject {
		private static final long serialVersionUID = 1358125776586152913L;
		/**
		 * 引用的关联对象字段格式
		 */
		@ApiField("format")
	...
	public static class RollUpSummaryFields extends TaobaoObject {
		private static final long serialVersionUID = 4775223896646954855L;
		/**
		 * 汇总方法
		 */
		@ApiField("aggregator")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 1112185826947376757L;
		/**
		 * 是否自定义字段
		 */
		@ApiField("customized")
	...
	public static class DObject extends TaobaoObject {
		private static final long serialVersionUID = 4823681953893854761L;
		/**
		 * 是否自定义对象
		 */
		@ApiField("customized")
