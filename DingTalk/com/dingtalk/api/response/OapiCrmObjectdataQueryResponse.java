...
public class OapiCrmObjectdataQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2351362397783118673L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 1293434576987198721L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class Values extends TaobaoObject {
		private static final long serialVersionUID = 7395529289715867427L;
		/**
		 * 创建记录的用户昵称
		 */
	...
	public static class IterablePage extends TaobaoObject {
		private static final long serialVersionUID = 5373739454676552427L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
