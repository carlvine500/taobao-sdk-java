...
public class OapiSmartworkHrmMasterCheckResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8118134161515443649L;
	...
	public static class Failresult extends TaobaoObject {
		private static final long serialVersionUID = 4228272964422543539L;
		/**
		 * 业务UK唯一确定一条流水
		 */
		@ApiField("biz_uk")
	...
	public static class IntegrateBatchResultVo extends TaobaoObject {
		private static final long serialVersionUID = 1884567296266939425L;
		/**
		 * 是否全部处理成功
		 */
