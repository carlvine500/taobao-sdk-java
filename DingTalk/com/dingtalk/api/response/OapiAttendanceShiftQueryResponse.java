...
public class OapiAttendanceShiftQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2591144931952555333L;
	...
	public static class TopShiftSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 3579555444443549317L;
		/**
		 * 该班次对应的出勤天数
		 */
	...
	public static class TopPunchVo extends TaobaoObject {
		private static final long serialVersionUID = 6586985525544317367L;
		/**
		 * 旷工早退迟到的时长
		 */
	...
	public static class TopRestVo extends TaobaoObject {
		private static final long serialVersionUID = 8491999786614248178L;
		/**
		 * 是否跨天
		 */
		@ApiField("across")
	...
	public static class TopSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 8639642411442996793L;
		/**
		 * id
		 */
		@ApiField("id")
	...
	public static class TopShiftVo extends TaobaoObject {
		private static final long serialVersionUID = 6484423792657353446L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
