...
public class OapiAlitripBtripTrainOrderSearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7313584756571519432L;
	...
	public static class OpenInvoiceDo extends TaobaoObject {
		private static final long serialVersionUID = 6663354514555847511L;
		/**
		 * 商旅发票id
		 */
		@ApiField("id")
	...
	public static class OpenCostCenterDo extends TaobaoObject {
		private static final long serialVersionUID = 3882428651331243888L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenPriceInfo extends TaobaoObject {
		private static final long serialVersionUID = 8629388685578885539L;
		/**
		 * 消费类型
		 */
		@ApiField("category")
	...
	public static class OpenUserAffiliateDo extends TaobaoObject {
		private static final long serialVersionUID = 7691973366951371897L;
		/**
		 * 乘车人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenTrainOrderRs extends TaobaoObject {
		private static final long serialVersionUID = 5598637959987499352L;
		/**
		 * 商旅审批单id
		 */
		@ApiField("apply_id")
	...
	public static class PageInfoRs extends TaobaoObject {
		private static final long serialVersionUID = 8146431665586799121L;
		/**
		 * 当前页
		 */
		@ApiField("page")
