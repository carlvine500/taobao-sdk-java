...
public class OapiCrmObjectdataFollowrecordQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4761319313936937274L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 5647765937752167821L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class Values extends TaobaoObject {
		private static final long serialVersionUID = 5312667788744471921L;
		/**
		 * 创建记录的用户昵称
		 */
	...
	public static class IterablePage extends TaobaoObject {
		private static final long serialVersionUID = 5552751934931242547L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
