...
public class OapiAlitripBtripPriceQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1488634292455751618L;
	...
	public static class HotelFeeDetail extends TaobaoObject {
		private static final long serialVersionUID = 2638355615812143481L;
		/**
		 * 城市
		 */
		@ApiField("city")
	...
	public static class MostExpensive extends TaobaoObject {
		private static final long serialVersionUID = 8776779623964248395L;
		/**
		 * 到达时间
		 */
		@ApiField("arr_time")
	...
	public static class Cheapest extends TaobaoObject {
		private static final long serialVersionUID = 2698432885341976428L;
		/**
		 * 到达时间
		 */
		@ApiField("arr_time")
	...
	public static class BtripRoutes extends TaobaoObject {
		private static final long serialVersionUID = 4723678455173167738L;
		/**
		 * 最低价
		 */
		@ApiField("cheapest")
	...
	public static class TrafficFee extends TaobaoObject {
		private static final long serialVersionUID = 7347279842274115733L;
		/**
		 * 行程费用
		 */
	...
	public static class Module extends TaobaoObject {
		private static final long serialVersionUID = 6413965998465777963L;
		/**
		 * 酒店差标
		 */
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 1439333695956446235L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
