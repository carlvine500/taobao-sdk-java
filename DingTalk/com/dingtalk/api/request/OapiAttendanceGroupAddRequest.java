...
public class OapiAttendanceGroupAddRequest extends BaseTaobaoRequest<OapiAttendanceGroupAddResponse> {
	...
	* 考勤组信息
	...
	public static class TopPositionVo extends TaobaoObject {
		private static final long serialVersionUID = 8484819348947932842L;
		/**
		 * 精度
		 */
		@ApiField("accuracy")
	...
	public static class TopShiftVo extends TaobaoObject {
		private static final long serialVersionUID = 2147653562572464992L;
		/**
		 * 班次id
		 */
		@ApiField("id")
	...
	public static class TopMemberVo extends TaobaoObject {
		private static final long serialVersionUID = 2449478639836963774L;
		/**
		 * corpId
		 */
		@ApiField("corp_id")
	...
	public static class TopGroupManageRolePermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 4166135764892683725L;
		/**
		 * 设置拍照打卡规则
		 */
	...
	public static class TopWifiVo extends TaobaoObject {
		private static final long serialVersionUID = 6325346127128359696L;
		/**
		 * 企业corpid
		 */
		@ApiField("corp_id")
	...
	public static class TopGroupVo extends TaobaoObject {
		private static final long serialVersionUID = 6234132412759998615L;
		/**
		 * 打卡是否需要健康码
		 */
