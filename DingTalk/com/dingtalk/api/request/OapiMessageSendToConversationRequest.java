...
public class OapiMessageSendToConversationRequest extends BaseTaobaoRequest<OapiMessageSendToConversationResponse> {
	...
	* voice消息
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 3217411386555534923L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class Form extends TaobaoObject {
		private static final long serialVersionUID = 7455777898843173917L;
		/**
		 * 消息体的关键字对应的值
		 */
		@ApiField("key")
	...
	public static class Rich extends TaobaoObject {
		private static final long serialVersionUID = 5149433299391973866L;
		/**
		 * 单行富文本信息的数目
		 */
		@ApiField("num")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 8362558722754689269L;
		/**
		 * 自定义的作者名字
		 */
		@ApiField("author")
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 2541798625765316731L;
		/**
	...
	public static class Oa extends TaobaoObject {
		private static final long serialVersionUID = 2112925343294196598L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 2349596241767623748L;
		/**
		 * 语音时长
		 */
		@ApiField("duration")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 5752693952649154891L;
		/**
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 5762456745573278563L;
		/**
		 * 消息点击链接地址
		 */
		@ApiField("messageUrl")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 7623185317154681514L;
		/**
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 1359483549447764278L;
		/**
		 * 消息内容
		 */
		@ApiField("content")
	...
	public static class BtnJson extends TaobaoObject {
		private static final long serialVersionUID = 1216154332244925444L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 3339565735665995418L;
		/**
		 * 使用独立跳转ActionCard样式时的按钮列表；必须与btn_orientation同时设置
		 */
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 5134267698349379135L;
		/**
		 * 消息内容，支持markdown，语法参考标准markdown语法。图片举例：![alt text](mediaId)
		 */
