...
public class OapiSmartworkHrmEmployeeUpdateRequest extends BaseTaobaoRequest<OapiSmartworkHrmEmployeeUpdateResponse> {
	...
	* 添加待入职入参
	...
	public static class EmpFieldVo extends TaobaoObject {
		private static final long serialVersionUID = 2544643537328258487L;
		/**
		 * 更新的字段code
		 */
		@ApiField("field_code")
	...
	public static class EmpListFieldVO extends TaobaoObject {
		private static final long serialVersionUID = 2725426759197762175L;
		/**
		 * 单个组所有字段
		 */
	...
	public static class GroupMetaInfo extends TaobaoObject {
		private static final long serialVersionUID = 2472475737367751191L;
		/**
		 * 需改的字段所在组ID
		 */
		@ApiField("group_id")
	...
	public static class PreEntryEmployeeAddParam extends TaobaoObject {
		private static final long serialVersionUID = 3617888654918192311L;
		/**
		 * 所有组明细
		 */
		@ApiListField("groups")
