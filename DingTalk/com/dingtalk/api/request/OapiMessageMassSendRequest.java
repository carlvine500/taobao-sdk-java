...
public class OapiMessageMassSendRequest extends BaseTaobaoRequest<OapiMessageMassSendResponse> {
	...
	* 调用时填写随机生成的UUID, 防止消息重复发送
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 4282996598542817965L;
		/**
		 * 正整数，小于60，表示音频时长
		 */
		@ApiField("duration")
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 2387247427992741775L;
		/**
	...
	public static class FormItem extends TaobaoObject {
		private static final long serialVersionUID = 4839722442873217272L;
		/**
		 * 消息体的关键字
		 */
		@ApiField("key")
	...
	public static class RichText extends TaobaoObject {
		private static final long serialVersionUID = 5287935726129924882L;
		/**
		 * 单行富文本信息的数目
		 */
		@ApiField("num")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 5153326522961669691L;
		/**
		 * 自定义的作者名字
		 */
		@ApiField("author")
	...
	public static class OA extends TaobaoObject {
		private static final long serialVersionUID = 6738481467959599859L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 2273581416842974926L;
		/**
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 2476315481437297693L;
		/**
		 * 消息点击链接地址，当发送消息为小程序时支持小程序跳转链接
		 */
		@ApiField("message_url")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 5194693158458993135L;
		/**
	...
	public static class Button extends TaobaoObject {
		private static final long serialVersionUID = 3296478485626677641L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 4826356819594526213L;
		/**
	...
	public static class MessageBody extends TaobaoObject {
		private static final long serialVersionUID = 5691475819547744317L;
		/**
		 * action_card卡片消息
		 */
