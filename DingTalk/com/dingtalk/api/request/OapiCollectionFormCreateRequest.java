...
public class OapiCollectionFormCreateRequest extends BaseTaobaoRequest<OapiCollectionFormCreateResponse> {
	...
	* 根请求
	...
	public static class ProcessVisibleValueVo extends TaobaoObject {
		private static final long serialVersionUID = 1682468192112784558L;
		/**
		 * 类型
		 */
	...
	public static class FormSchemaSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 2472724212695949198L;
		/**
		 * 业务类型
		 */
		@ApiField("biz_type")
	...
	public static class BehaviorTarget extends TaobaoObject {
		private static final long serialVersionUID = 1123662465275123975L;
		/**
		 * 行为
		 */
		@ApiField("behavior")
	...
	public static class BehaviorLinkageVo extends TaobaoObject {
		private static final long serialVersionUID = 2826739236497143866L;
		/**
		 * 选项级联目标
		 */
	...
	public static class ComponentPropOptionVo extends TaobaoObject {
		private static final long serialVersionUID = 2884822154354657254L;
		/**
		 * 名称
		 */
		@ApiField("key")
	...
	public static class ComponentMatrixDefVo extends TaobaoObject {
		private static final long serialVersionUID = 6619952873523273299L;
		/**
		 * 别名
		 */
		@ApiField("alias")
	...
	public static class ComponentPropVo extends TaobaoObject {
		private static final long serialVersionUID = 4871842239264914439L;
		/**
		 * 选项级联属性
		 */
	...
	public static class FormComponentVo extends TaobaoObject {
		private static final long serialVersionUID = 1566687282618135826L;
		/**
		 * 控件名称
		 */
	...
	public static class FormContentVo extends TaobaoObject {
		private static final long serialVersionUID = 8615445973164613833L;
		/**
		 * 控件数组
		 */
		@ApiListField("items")
	...
	public static class SwFormVisibleValueVo extends TaobaoObject {
		private static final long serialVersionUID = 5693854331783381812L;
		/**
		 * cid是否加密
		 */
	...
	public static class SaveFormSchemaRequest extends TaobaoObject {
		private static final long serialVersionUID = 2194924651994826148L;
		/**
		 * 控件字符串
		 */
		@ApiField("content")
