...
public class OapiAtsJobBatchaddRequest extends BaseTaobaoRequest<OapiAtsJobBatchaddResponse> {
	...
	* 操作人员工标识
	...
	public static class JobExtDataVo extends TaobaoObject {
		private static final long serialVersionUID = 7815676332933269495L;
		/**
		 * 招募人数
		 */
		@ApiField("head_count")
	...
	public static class JobAddressVo extends TaobaoObject {
		private static final long serialVersionUID = 8734661558823759925L;
		/**
		 * 位置详情
		 */
		@ApiField("detail")
	...
	public static class AtsAddJobParam extends TaobaoObject {
		private static final long serialVersionUID = 3361583853357523744L;
		/**
		 * 工作地点
		 */
		@ApiField("address")
