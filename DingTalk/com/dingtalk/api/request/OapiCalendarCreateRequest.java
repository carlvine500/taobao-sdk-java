...
public class OapiCalendarCreateRequest extends BaseTaobaoRequest<OapiCalendarCreateResponse> {
	...
	* 创建日程实体
	...
	public static class OpenCalendarReminderVo extends TaobaoObject {
		private static final long serialVersionUID = 5574558186471755889L;
		/**
		 * 距开始时多久进行提醒(单位:分钟)
		 */
		@ApiField("minutes")
	...
	public static class DatetimeVo extends TaobaoObject {
		private static final long serialVersionUID = 7261893916389351675L;
		/**
		 * 时区
		 */
		@ApiField("timezone")
	...
	public static class OpenCalendarSourceVo extends TaobaoObject {
		private static final long serialVersionUID = 6389241426453623555L;
		/**
		 * 日程来源
		 */
		@ApiField("title")
	...
	public static class OpenCalendarCreateVo extends TaobaoObject {
		private static final long serialVersionUID = 4441937954623295169L;
		/**
		 * 业务方自己的主键
		 */
		@ApiField("biz_id")
