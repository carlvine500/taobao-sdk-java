...
public class OapiMessageCorpconversationAsyncsendV2Request extends BaseTaobaoRequest<OapiMessageCorpconversationAsyncsendV2Response> {
	...
	* 接收者的用户userid列表
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 8155468852425438621L;
		/**
		 * 文本消息
		 */
		@ApiField("content")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 2186282771122335298L;
		/**
		 * 图片消息
		 */
		@ApiField("media_id")
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 6286418632782966496L;
		/**
		 * 消息点击链接地址
		 */
		@ApiField("messageUrl")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 4545725614639622628L;
		/**
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 7395663137529811718L;
		/**
		 * 正整数，小于60，表示音频时长
		 */
		@ApiField("duration")
	...
	public static class Rich extends TaobaoObject {
		private static final long serialVersionUID = 8383134595662684724L;
		/**
		 * 单行富文本信息的数目
		 */
		@ApiField("num")
	...
	public static class Form extends TaobaoObject {
		private static final long serialVersionUID = 7165145166721328421L;
		/**
		 * 消息体的关键字
		 */
		@ApiField("key")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 6759833718361238498L;
		/**
		 * 自定义的作者名字
		 */
		@ApiField("author")
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 7632156364642429565L;
		/**
	...
	public static class StatusBar extends TaobaoObject {
		private static final long serialVersionUID = 8875491799328957737L;
		/**
		 * 状态栏背景色，默认为黑色
		 */
		@ApiField("status_bg")
	...
	public static class OA extends TaobaoObject {
		private static final long serialVersionUID = 2612343625611327848L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 1391131537244275253L;
		/**
	...
	public static class BtnJsonList extends TaobaoObject {
		private static final long serialVersionUID = 4238841564739432725L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 7513143726312834438L;
		/**
		 * 使用独立跳转ActionCard样式时的按钮列表；必须与btn_orientation同时设置
		 */
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 8294529872285624486L;
		/**
		 * 卡片消息
		 */
