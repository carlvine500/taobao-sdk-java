...
public class OapiCalendarV2EventCreateRequest extends BaseTaobaoRequest<OapiCalendarV2EventCreateResponse> {
	...
	* 日程创建对象
	...
	public static class Attendee extends TaobaoObject {
		private static final long serialVersionUID = 3769594982994669283L;
		/**
		 * 员工工号
		 */
		@ApiField("userid")
	...
	public static class DateTime extends TaobaoObject {
		private static final long serialVersionUID = 7469248159399814235L;
		/**
	...
	public static class OpenCalendarReminderVo extends TaobaoObject {
		private static final long serialVersionUID = 4186421828283655644L;
		/**
		 * 提醒方式.app表示应用内提醒
		 */
		@ApiField("method")
	...
	public static class LocationVo extends TaobaoObject {
		private static final long serialVersionUID = 1155249934246346329L;
		/**
		 * 纬度
		 */
		@ApiField("latitude")
	...
	public static class Event extends TaobaoObject {
		private static final long serialVersionUID = 7849867533166323856L;
		/**
		 * 日程参与者，参与者最大人数为100(包括组织者)
		 */
