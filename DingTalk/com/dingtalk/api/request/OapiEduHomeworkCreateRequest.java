...
public class OapiEduHomeworkCreateRequest extends BaseTaobaoRequest<OapiEduHomeworkCreateResponse> {
	...
	* 老师userid
	...
	public static class ClassInfoItem extends TaobaoObject {
		private static final long serialVersionUID = 6459592713265147753L;
		/**
		 * 班级ID
		 */
		@ApiField("class_id")
	...
	public static class StuInfoItem extends TaobaoObject {
		private static final long serialVersionUID = 6635299295742649394L;
		/**
		 * 学生userid
		 */
		@ApiField("stu_id")
	...
	public static class SelectStuItem extends TaobaoObject {
		private static final long serialVersionUID = 3153514732856497126L;
		/**
		 * 班级ID
		 */
		@ApiField("class_id")
