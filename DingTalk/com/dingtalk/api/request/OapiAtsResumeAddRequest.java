...
public class OapiAtsResumeAddRequest extends BaseTaobaoRequest<OapiAtsResumeAddResponse> {
	...
	* 简历文件参数
	...
	public static class EducationInfo extends TaobaoObject {
		private static final long serialVersionUID = 8649491498684697451L;
		/**
		 * 学历
		 */
		@ApiField("education")
	...
	public static class ExperienceInfo extends TaobaoObject {
		private static final long serialVersionUID = 1839385633981162531L;
		/**
		 * 公司名称
		 */
		@ApiField("company")
	...
	public static class TrainingInfo extends TaobaoObject {
		private static final long serialVersionUID = 8311459372971737126L;
		/**
		 * 所获证书
		 */
	...
	public static class ProjectInfo extends TaobaoObject {
		private static final long serialVersionUID = 1383953749221128554L;
		/**
		 * 结束时间
		 */
		@ApiField("end_date")
	...
	public static class ResumeDetailInfo extends TaobaoObject {
		private static final long serialVersionUID = 5559474422266528923L;
		/**
		 * 学位
		 */
	...
	public static class ResumeFileStoreVo extends TaobaoObject {
		private static final long serialVersionUID = 6761741137549554458L;
		/**
		 * 下载地址
		 */
	...
	public static class MailContent extends TaobaoObject {
		private static final long serialVersionUID = 6463479349728422157L;
		/**
		 * 邮件正文，可选
		 */
		@ApiField("body_html")
	...
	public static class CollResumeMailParam extends TaobaoObject {
		private static final long serialVersionUID = 8644249711878976345L;
		/**
		 * 渠道来源，接入前请提前沟通
		 */
		@ApiField("channel")
