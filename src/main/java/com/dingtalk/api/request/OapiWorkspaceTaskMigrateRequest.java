...
public class OapiWorkspaceTaskMigrateRequest extends BaseTaobaoRequest<OapiWorkspaceTaskMigrateResponse> {
	...
	* 请求入参
	...
	public static class TaskSystemProperty extends TaobaoObject {
		private static final long serialVersionUID = 5876142553919961124L;
		/**
		 * APP 跳转链接
		 */
		@ApiField("appUrl")
	...
	public static class TaskExtension extends TaobaoObject {
		private static final long serialVersionUID = 2339957678821238331L;
		/**
		 * 评论数
		 */
	...
	public static class TaskCreate extends TaobaoObject {
		private static final long serialVersionUID = 2525978543892891775L;
		/**
