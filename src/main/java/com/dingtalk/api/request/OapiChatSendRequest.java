...
public class OapiChatSendRequest extends BaseTaobaoRequest<OapiChatSendResponse> {
	...
	* 语音消息
	...
	public static class BtnJson extends TaobaoObject {
		private static final long serialVersionUID = 7276564484899541213L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 4344559196783249461L;
		/**
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 6357597421817198655L;
		/**
		 * 消息头部背景颜色
		 */
		@ApiField("bgcolor")
	...
	public static class Rich extends TaobaoObject {
		private static final long serialVersionUID = 4716291771949386866L;
		/**
		 * 单行富文本信息的单位
		 */
		@ApiField("num")
	...
	public static class Form extends TaobaoObject {
		private static final long serialVersionUID = 5743136694413863784L;
		/**
		 * 消息体的关键字
		 */
		@ApiField("key")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 3666665929868327687L;
		/**
		 * 自定义的作者名字
		 */
		@ApiField("author")
	...
	public static class Oa extends TaobaoObject {
		private static final long serialVersionUID = 2623557579377914859L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 7486785931928429121L;
		/**
		 * 语音正整数，小于60，表示音频时长长
		 */
		@ApiField("duration")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 1713652997444965466L;
		/**
		 * 文件mediaId
		 */
		@ApiField("media_id")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 8831763716973573813L;
		/**
		 * 图片mediaId
		 */
		@ApiField("media_id")
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 4493185382657333998L;
		/**
		 * 消息点击链接地址
		 */
		@ApiField("messageUrl")
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 5742595265565419463L;
		/**
		 * 文本消息内容
		 */
		@ApiField("content")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 6185574619217852844L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class BtnJsonList extends TaobaoObject {
		private static final long serialVersionUID = 8478338962253442398L;
		/**
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 4525341993299143519L;
		/**
		 * action_card卡片消息
		 */
