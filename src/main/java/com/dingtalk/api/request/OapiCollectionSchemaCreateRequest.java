...
public class OapiCollectionSchemaCreateRequest extends BaseTaobaoRequest<OapiCollectionSchemaCreateResponse> {
	...
	* 根请求
	...
	public static class ProcessVisibleValueVo extends TaobaoObject {
		private static final long serialVersionUID = 7898734286331727569L;
		/**
		 * 类型
		 */
	...
	public static class FormSchemaSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 5674118887643652622L;
		/**
		 * 业务类型
		 */
		@ApiField("biz_type")
	...
	public static class BehaviorTarget extends TaobaoObject {
		private static final long serialVersionUID = 3647445873178627947L;
		/**
		 * 行为
		 */
		@ApiField("behavior")
	...
	public static class BehaviorLinkageVo extends TaobaoObject {
		private static final long serialVersionUID = 7699118429445876455L;
		/**
		 * 选项级联目标
		 */
	...
	public static class ComponentPropOptionVo extends TaobaoObject {
		private static final long serialVersionUID = 2475221894838599741L;
		/**
		 * 名称
		 */
		@ApiField("key")
	...
	public static class ComponentMatrixDefVo extends TaobaoObject {
		private static final long serialVersionUID = 7375772884488179581L;
		/**
		 * 别名
		 */
		@ApiField("alias")
	...
	public static class ComponentPropVo extends TaobaoObject {
		private static final long serialVersionUID = 6522359663629631849L;
		/**
		 * 选项级联属性
		 */
	...
	public static class FormComponentVo extends TaobaoObject {
		private static final long serialVersionUID = 5264931462521253428L;
		/**
		 * 控件名称
		 */
	...
	public static class FormContentVo extends TaobaoObject {
		private static final long serialVersionUID = 8824763437786833247L;
		/**
		 * 控件数组
		 */
		@ApiListField("items")
	...
	public static class SaveFormSchemaRequest extends TaobaoObject {
		private static final long serialVersionUID = 8724833837622152148L;
		/**
		 * 控件字符串
		 */
		@ApiField("content")
