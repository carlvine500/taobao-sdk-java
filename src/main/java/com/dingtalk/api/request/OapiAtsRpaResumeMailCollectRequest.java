...
public class OapiAtsRpaResumeMailCollectRequest extends BaseTaobaoRequest<OapiAtsRpaResumeMailCollectResponse> {
	...
	* 简历文件参数
	...
	public static class MailContent extends TaobaoObject {
		private static final long serialVersionUID = 7664433221776132613L;
		/**
		 * 邮件正文，可选
		 */
		@ApiField("body_html")
	...
	public static class ResumeFileStoreVo extends TaobaoObject {
		private static final long serialVersionUID = 6313268566412984932L;
		/**
		 * 下载地址
		 */
	...
	public static class EducationInfo extends TaobaoObject {
		private static final long serialVersionUID = 8214498723965547916L;
		/**
		 * 学历
		 */
		@ApiField("education")
	...
	public static class ExperienceInfo extends TaobaoObject {
		private static final long serialVersionUID = 2646895632254598856L;
		/**
		 * 公司名称
		 */
		@ApiField("company")
	...
	public static class TrainingInfo extends TaobaoObject {
		private static final long serialVersionUID = 4782182715842519769L;
		/**
		 * 所获证书
		 */
	...
	public static class ProjectInfo extends TaobaoObject {
		private static final long serialVersionUID = 8227572898654577117L;
		/**
		 * 结束时间
		 */
		@ApiField("end_date")
	...
	public static class ResumeDetailInfo extends TaobaoObject {
		private static final long serialVersionUID = 8812561626129545182L;
		/**
		 * 学位
		 */
	...
	public static class CollResumeMailParam extends TaobaoObject {
		private static final long serialVersionUID = 8471345739723738962L;
		/**
		 * 渠道来源，接入前请提前沟通
		 */
		@ApiField("channel")
