...
public class OapiPlanetomFeedsUploadRequest extends BaseTaobaoRequest<OapiPlanetomFeedsUploadResponse> {
	...
	* 提交人的手机号码
	...
	public static class FeedContentModel extends TaobaoObject {
		private static final long serialVersionUID = 4852622428311688314L;
		/**
		 * 内容类型 2 视频 3 音频
		 */
		@ApiField("feed_type")
	...
	public static class FeedBaseModel extends TaobaoObject {
		private static final long serialVersionUID = 2476515485671113173L;
		/**
		 * 课程封面URL
		 */
		@ApiField("cover_url")
	...
	public static class FeedPayModel extends TaobaoObject {
		private static final long serialVersionUID = 2393954978996832648L;
		/**
		 * 客服手机号码
		 */
		@ApiField("cs_phone")
	...
	public static class BatchUploadFeedInfoModel extends TaobaoObject {
		private static final long serialVersionUID = 6536793732429794564L;
		/**
		 * 课程基础
		 */
		@ApiField("base_model")
