...
public class OapiRobotSendRequest extends BaseTaobaoRequest<OapiRobotSendResponse> {
	...
	* text类型
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 2574179837399144118L;
		/**
		 * text类型
		 */
		@ApiField("content")
	...
	public static class At extends TaobaoObject {
		private static final long serialVersionUID = 8759731926637169512L;
		/**
		 * 被@人的手机号
		 */
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 8412681526457835431L;
		/**
		 * 点击消息跳转的URL
		 */
		@ApiField("messageUrl")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 4212751917193617895L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class Btns extends TaobaoObject {
		private static final long serialVersionUID = 6489677265214834852L;
		/**
		 * 按钮方案，
		 */
		@ApiField("actionURL")
	...
	public static class Actioncard extends TaobaoObject {
		private static final long serialVersionUID = 7825396643296662864L;
		/**
		 * 0-按钮竖直排列，1-按钮横向排列
		 */
	...
	public static class Links extends TaobaoObject {
		private static final long serialVersionUID = 2283724223723242918L;
		/**
		 * 点击单条信息到跳转链接
		 */
		@ApiField("messageURL")
	...
	public static class Feedcard extends TaobaoObject {
		private static final long serialVersionUID = 5854668424645137795L;
		/**
		 * links
		 */
		@ApiListField("links")
