...
public class OapiWorkspaceCirclePostCreateRequest extends BaseTaobaoRequest<OapiWorkspaceCirclePostCreateResponse> {
	...
	* 创建动态的入参
	...
	public static class FvDingPanFileContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 1129194469637357787L;
		/**
	...
	public static class FvAttachmentsOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 2747933312151823752L;
		/**
		 * 钉盘文件列表
		 */
	...
	public static class FvPhotoOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 3573769666626513112L;
		/**
	...
	public static class FvPhotoContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 5561877132271248838L;
		/**
		 * 图片内容列表
		 */
		@ApiListField("photos")
	...
	public static class FvVideoContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 5221269265419524744L;
		/**
		 * 视频比特率
		 */
		@ApiField("bitrate")
	...
	public static class FvPostContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 7889676626417196362L;
		/**
		 * 附件内容
		 */
	...
	public static class FvPostTagOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 2488837197474769731L;
		/**
		 * 标签名
		 */
		@ApiField("name")
	...
	public static class FvPostCreateOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 6758261457484286562L;
		/**
		 * 动态的内容
		 */
		@ApiField("content")
