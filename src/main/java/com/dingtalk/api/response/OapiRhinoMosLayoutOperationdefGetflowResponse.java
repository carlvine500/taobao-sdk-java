...
public class OapiRhinoMosLayoutOperationdefGetflowResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3683379873146517545L;
	...
	public static class OperationExecutorAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 6583216947156917116L;
		/**
		 * 工序执行器ID
		 */
	...
	public static class DeviceAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 4539668482173851818L;
		/**
		 * 设备ID
		 */
		@ApiField("device_id")
	...
	public static class WorkerAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 6648867656227378746L;
		/**
		 * 姓名
		 */
		@ApiField("name")
	...
	public static class WorkstationAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 1741126188935945332L;
		/**
		 * 站位编码
		 */
	...
	public static class WorkUnitDto extends TaobaoObject {
		private static final long serialVersionUID = 5787722922949363229L;
		/**
		 * 设备分配列表
		 */
	...
	public static class OperationDefDto extends TaobaoObject {
		private static final long serialVersionUID = 6121918163988479778L;
		/**
		 * 适用尺码
		 */
	...
	public static class OperationDefFlowDto extends TaobaoObject {
		private static final long serialVersionUID = 7317785429393738214L;
		/**
		 * 是否激活最大版本
		 */
		@ApiField("active")
