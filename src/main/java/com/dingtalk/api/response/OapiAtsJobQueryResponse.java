...
public class OapiAtsJobQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3834842831512993963L;
	...
	public static class JobSimpleVo extends TaobaoObject {
		private static final long serialVersionUID = 8249887252238815374L;
		/**
		 * true表示校招，false表示社招
		 */
		@ApiField("campus")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 4299872232425775419L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
