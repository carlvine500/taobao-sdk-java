...
public class OapiSmartdeviceFocusdetailGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3334721679894698723L;
	...
	public static class FocusDetailVO extends TaobaoObject {
		private static final long serialVersionUID = 6226624944162693774L;
		/**
		 * 投屏时间，单位毫秒
		 */
	...
	public static class PageVO extends TaobaoObject {
		private static final long serialVersionUID = 1681627382459642981L;
		/**
		 * 是否有更多记录
		 */
		@ApiField("has_more")
