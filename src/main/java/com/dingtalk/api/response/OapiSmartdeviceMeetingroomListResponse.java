...
public class OapiSmartdeviceMeetingroomListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8239536314476196163L;
	...
	public static class MeetingRoomOpenInfo extends TaobaoObject {
		private static final long serialVersionUID = 7454893286383336488L;
		/**
		 * 会议室容量
		 */
		@ApiField("capacity")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 1683265513239763283L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
