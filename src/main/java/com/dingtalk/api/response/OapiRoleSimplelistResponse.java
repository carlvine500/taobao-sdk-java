...
public class OapiRoleSimplelistResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7477523311475983185L;
	...
	public static class OrgDeptVo extends TaobaoObject {
		private static final long serialVersionUID = 6322473977745162963L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class OpenEmpSimple extends TaobaoObject {
		private static final long serialVersionUID = 5152224572654949155L;
		/**
		 * 管理范围
		 */
	...
	public static class PageVo extends TaobaoObject {
		private static final long serialVersionUID = 2861962453382316263L;
		/**
		 * 后面是否还有数据
		 */
		@ApiField("hasMore")
