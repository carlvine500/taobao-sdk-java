...
public class OapiDdpaasObjectdataQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8662258511436442689L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 6485851851171262964L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class Values extends TaobaoObject {
		private static final long serialVersionUID = 7869873611265484649L;
		/**
		 * 创建记录的用户昵称
		 */
	...
	public static class IterablePage extends TaobaoObject {
		private static final long serialVersionUID = 2712933619751168242L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
