...
public class OapiSmartworkHrmMasterDeleteResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8877974198556549347L;
	...
	public static class Failresult extends TaobaoObject {
		private static final long serialVersionUID = 1746311773332775168L;
		/**
		 * 业务UK,唯一确定一条流水
		 */
		@ApiField("biz_uk")
	...
	public static class IntegrateBatchResultVo extends TaobaoObject {
		private static final long serialVersionUID = 2831654316575116731L;
		/**
		 * 是否全部成功
		 */
