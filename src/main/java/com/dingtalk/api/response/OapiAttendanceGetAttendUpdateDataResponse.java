...
public class OapiAttendanceGetAttendUpdateDataResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2566715624613883881L;
	...
	public static class AtAttendanceResultForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 2744431745279723844L;
		/**
		 * 打卡类型 上班还是下班
		 */
		@ApiField("check_type")
	...
	public static class AtApproveForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 4815852611894292282L;
		/**
		 * 审批单开始时间
		 */
		@ApiField("begin_time")
	...
	public static class AtAttendanceRecordForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 2162274342871259379L;
		/**
		 * 基本定位精度
		 */
	...
	public static class AtCheckInfoForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 2887597713652957863L;
		/**
		 * 审批单列表
		 */
