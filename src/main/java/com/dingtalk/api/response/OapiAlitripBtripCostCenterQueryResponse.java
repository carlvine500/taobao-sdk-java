...
public class OapiAlitripBtripCostCenterQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4192893629176611533L;
	...
	public static class OpenOrgEntityDo extends TaobaoObject {
		private static final long serialVersionUID = 4758412599586751881L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenCostCenterQueryRs extends TaobaoObject {
		private static final long serialVersionUID = 7196999189374566396L;
		/**
		 * 绑定支付宝账号
		 */
		@ApiField("alipay_no")
