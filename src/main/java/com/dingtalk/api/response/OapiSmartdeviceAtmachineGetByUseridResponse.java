...
public class OapiSmartdeviceAtmachineGetByUseridResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4456224565723684785L;
	...
	public static class MachineVo extends TaobaoObject {
		private static final long serialVersionUID = 2773914963568746952L;
		/**
		 * 考勤机名称
		 */
	...
	public static class MachineInfoResultVo extends TaobaoObject {
		private static final long serialVersionUID = 7613722924497578157L;
		/**
		 * 分页查询中，后页是否还有数据
		 */
		@ApiField("has_more")
