...
public class OapiKacDatavVideoconfDetailListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6637951764769294268L;
	...
	public static class McsDetailVo extends TaobaoObject {
		private static final long serialVersionUID = 7319812855949664852L;
		/**
		 * 会议id
		 */
		@ApiField("conf_id")
	...
	public static class McsDetailResponse extends TaobaoObject {
		private static final long serialVersionUID = 5129737528973589776L;
		/**
		 * data
		 */
		@ApiListField("data")
