...
public class OapiAlitripBtripApplySearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3331941623672988227L;
	...
	public static class OpenItineraryInfo extends TaobaoObject {
		private static final long serialVersionUID = 2389795643192564136L;
		/**
		 * 到达城市
		 */
		@ApiField("arr_city")
	...
	public static class OpenUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 8368524688898775631L;
		/**
		 * 用户名称
		 */
		@ApiField("user_name")
	...
	public static class OpenApproverInfo extends TaobaoObject {
		private static final long serialVersionUID = 3855616819988125773L;
		/**
		 * 审批意见
		 */
		@ApiField("note")
	...
	public static class OpenApplyRs extends TaobaoObject {
		private static final long serialVersionUID = 5736744933914173568L;
		/**
		 * 商旅审批展示id
		 */
