...
public class OapiReportListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3279146266237888352L;
	...
	public static class JsonObject extends TaobaoObject {
		private static final long serialVersionUID = 4669831411956851873L;
		/**
		 * 模板内容
		 */
		@ApiField("key")
	...
	public static class ReportOapiVo extends TaobaoObject {
		private static final long serialVersionUID = 4253846113515112482L;
		/**
		 * 日志内容
		 */
	...
	public static class PageVo extends TaobaoObject {
		private static final long serialVersionUID = 8439697557788658226L;
		/**
		 * 日志列表
		 */
