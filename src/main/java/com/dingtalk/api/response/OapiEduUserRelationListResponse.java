...
public class OapiEduUserRelationListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7567365428343178793L;
	...
	public static class OpenEduUserRelationDetail extends TaobaoObject {
		private static final long serialVersionUID = 2381614516593264689L;
		/**
		 * 班级id
		 */
		@ApiField("class_id")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 1251396468742151663L;
		/**
		 * 是否还存在数据
		 */
		@ApiField("has_more")
