...
public class OapiDingmiGroupGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5721312876892845852L;
	...
	public static class GroupMemberChatData extends TaobaoObject {
		private static final long serialVersionUID = 5165354956383614935L;
		/**
		 * 聊天记录数
		 */
		@ApiField("chat_cnt")
	...
	public static class GroupChatDataResult extends TaobaoObject {
		private static final long serialVersionUID = 2759945856553675696L;
		/**
		 * 是否来自缓存
		 */
		@ApiField("from_cache")
