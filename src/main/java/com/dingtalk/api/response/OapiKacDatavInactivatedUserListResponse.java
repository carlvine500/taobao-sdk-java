...
public class OapiKacDatavInactivatedUserListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7434338239547675212L;
	...
	public static class UnactivatedUserVo extends TaobaoObject {
		private static final long serialVersionUID = 5883717714853176517L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class UnactivatedUserResponse extends TaobaoObject {
		private static final long serialVersionUID = 5841568671492693148L;
		/**
		 * 人员列表
		 */
		@ApiListField("data")
