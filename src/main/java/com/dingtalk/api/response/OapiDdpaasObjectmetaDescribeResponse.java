...
public class OapiDdpaasObjectmetaDescribeResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3869932969916165131L;
	...
	public static class Selectoptions extends TaobaoObject {
		private static final long serialVersionUID = 5296943114122339983L;
		/**
		 * 选项key
		 */
		@ApiField("key")
	...
	public static class Referencefields extends TaobaoObject {
		private static final long serialVersionUID = 2581578836665336362L;
		/**
		 * 引用的关联对象字段格式
		 */
		@ApiField("format")
	...
	public static class Rollupsummaryfields extends TaobaoObject {
		private static final long serialVersionUID = 4493512613265965615L;
		/**
		 * 汇总方法
		 */
		@ApiField("aggregator")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 1225482972933486977L;
		/**
		 * 是否自定义字段
		 */
		@ApiField("customized")
	...
	public static class DObject extends TaobaoObject {
		private static final long serialVersionUID = 5857358416688189912L;
		/**
		 * 字段列表
		 */
		@ApiListField("fields")
