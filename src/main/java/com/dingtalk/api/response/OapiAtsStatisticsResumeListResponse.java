...
public class OapiAtsStatisticsResumeListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8459223249772318333L;
	...
	public static class TopResumeStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 5359993852919152369L;
		/**
		 * 招聘业务标识
		 */
		@ApiField("biz_code")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 8539997696213629444L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
