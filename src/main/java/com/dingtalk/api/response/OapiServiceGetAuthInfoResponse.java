...
public class OapiServiceGetAuthInfoResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5858461286449331644L;
	...
	public static class Agent extends TaobaoObject {
		private static final long serialVersionUID = 4371136559379981216L;
		/**
		 * admin_list
		 */
	...
	public static class AuthInfo extends TaobaoObject {
		private static final long serialVersionUID = 2838672839592787979L;
		/**
		 * agent
		 */
		@ApiListField("agent")
	...
	public static class AuthUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 3415646773669453797L;
		/**
		 * userId
		 */
		@ApiField("userId")
	...
	public static class AuthCorpInfo extends TaobaoObject {
		private static final long serialVersionUID = 5479712784729583494L;
		/**
		 * auth_channel
		 */
	...
	public static class Channelagent extends TaobaoObject {
		private static final long serialVersionUID = 2455131874565638263L;
		/**
		 * agent_name
		 */
		@ApiField("agent_name")
	...
	public static class ChannelAuthInfo extends TaobaoObject {
		private static final long serialVersionUID = 8384154543979249551L;
		/**
		 * channelAgent
		 */
