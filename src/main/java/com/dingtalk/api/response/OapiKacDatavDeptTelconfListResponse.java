...
public class OapiKacDatavDeptTelconfListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4842965571796316252L;
	...
	public static class TelConferenceDeptSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 7847414425628341341L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class TelConferenceDeptSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 3423649662197431448L;
		/**
		 * data
		 */
		@ApiListField("data")
