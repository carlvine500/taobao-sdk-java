...
public class OapiWorkspaceCorpMemberAddResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4468397295431956197L;
	...
	public static class OpenTagDto extends TaobaoObject {
		private static final long serialVersionUID = 4546567631281449237L;
		/**
		 * 角色的code
		 */
		@ApiField("code")
	...
	public static class OpenMemberDto extends TaobaoObject {
		private static final long serialVersionUID = 3625186755328693334L;
		/**
		 * 组织id
		 */
		@ApiField("corp_id")
