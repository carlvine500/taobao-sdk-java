...
public class OapiIndustryUserListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2283596833924253568L;
	...
	public static class OpenRole extends TaobaoObject {
		private static final long serialVersionUID = 5145613993938713916L;
		/**
		 * 标签id
		 */
		@ApiField("id")
	...
	public static class OpenIndustryEmp extends TaobaoObject {
		private static final long serialVersionUID = 8776267744797377861L;
		/**
		 * 员工特征
		 */
		@ApiField("feature")
	...
	public static class ResultWrapper extends TaobaoObject {
		private static final long serialVersionUID = 6288771312244646538L;
		/**
		 * 员工列表
		 */
