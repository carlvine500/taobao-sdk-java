...
public class OapiRobotMessageStatisticsListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2199755361539386299L;
	...
	public static class MsgStatResVo extends TaobaoObject {
		private static final long serialVersionUID = 8374476781415524168L;
		/**
		 * 机器人消息推送Id
		 */
		@ApiField("push_id")
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 4883259364782897162L;
		/**
		 * 当前页数
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 6214993461327232499L;
		/**
		 * list
		 */
		@ApiListField("list")
