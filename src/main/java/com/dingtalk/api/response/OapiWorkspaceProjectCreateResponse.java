...
public class OapiWorkspaceProjectCreateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7433828336494169183L;
	...
	public static class OpenTagDto extends TaobaoObject {
		private static final long serialVersionUID = 6657836876668753124L;
		/**
		 * 角色code
		 */
		@ApiField("code")
	...
	public static class OpenProjectMemberDto extends TaobaoObject {
		private static final long serialVersionUID = 7283851966587732668L;
		/**
		 * 开放组织id
		 */
		@ApiField("corp_id")
	...
	public static class OpenProjectDto extends TaobaoObject {
		private static final long serialVersionUID = 3781813973321742846L;
		/**
		 * 开放组织id
		 */
		@ApiField("corp_id")
