...
public class OapiSceneservicegroupGroupQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6433539949145944575L;
	...
	public static class GroupResponse extends TaobaoObject {
		private static final long serialVersionUID = 1648711241545129629L;
		/**
		 * 群名称
		 */
		@ApiField("group_name")
	...
	public static class Page extends TaobaoObject {
		private static final long serialVersionUID = 2835325698286937729L;
		/**
		 * 表示是否还有更多的数据
		 */
		@ApiField("has_more")
