...
public class OapiSmartdeviceAtmachineGetByDeptidResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4872691865719816762L;
	...
	public static class MachineVo extends TaobaoObject {
		private static final long serialVersionUID = 7514482253455855445L;
		/**
		 * 考勤机名称
		 */
	...
	public static class MachineInfoResultVo extends TaobaoObject {
		private static final long serialVersionUID = 5356421432838939592L;
		/**
		 * 分页查询中，后页是否还有数据
		 */
		@ApiField("has_more")
