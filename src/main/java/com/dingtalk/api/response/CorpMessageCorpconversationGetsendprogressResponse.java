...
public class CorpMessageCorpconversationGetsendprogressResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6892144919472553287L;
	...
	public static class AsyncSendProgress extends TaobaoObject {
		private static final long serialVersionUID = 6725367214337531827L;
		/**
		 * 取值 0-100，表示处理的百分比
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 5848522385666129199L;
		/**
		 * dingOpenErrcode
		 */
