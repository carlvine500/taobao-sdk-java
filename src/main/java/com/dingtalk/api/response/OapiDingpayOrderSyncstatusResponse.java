...
public class OapiDingpayOrderSyncstatusResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3322541336982215142L;
	...
	public static class Orders extends TaobaoObject {
		private static final long serialVersionUID = 4827678454157957128L;
		/**
		 * 金额（单位：分）
		 */
		@ApiField("amount")
	...
	public static class OrderSyncStatusOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 1518729868814656174L;
		/**
		 * orders
		 */
		@ApiListField("orders")
