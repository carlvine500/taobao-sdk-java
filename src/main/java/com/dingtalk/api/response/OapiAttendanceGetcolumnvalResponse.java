...
public class OapiAttendanceGetcolumnvalResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3199773659899424415L;
	...
	public static class ColumnDayAndVal extends TaobaoObject {
		private static final long serialVersionUID = 4176588784385186812L;
		/**
		 * 时间
		 */
		@ApiField("date")
	...
	public static class ColumnForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 7621836356488225979L;
		/**
		 * 列id
		 */
		@ApiField("id")
	...
	public static class ColumnValForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 6676813611234246214L;
		/**
		 * 列值数据
		 */
	...
	public static class ColumnValListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 6666452721425837266L;
		/**
		 * 列信息与列值数据
		 */
		@ApiListField("column_vals")
