...
public class OapiAttendanceGroupMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4179388199481975675L;
	...
	public static class TopGroupMemberVo extends TaobaoObject {
		private static final long serialVersionUID = 1635958438172178477L;
		/**
		 * 0表示需要考勤，1表示无需考勤人员
		 */
		@ApiField("atc_flag")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 3886479688975261411L;
		/**
		 * 游标
		 */
		@ApiField("cursor")
