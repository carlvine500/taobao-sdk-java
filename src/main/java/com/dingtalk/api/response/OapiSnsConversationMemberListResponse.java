...
public class OapiSnsConversationMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5613273913429492791L;
	...
	public static class SnsGroupMemberModel extends TaobaoObject {
		private static final long serialVersionUID = 7433188856493376491L;
		/**
		 * 群昵称
		 */
	...
	public static class SnsOpenGroupMemberResponse extends TaobaoObject {
		private static final long serialVersionUID = 5449334634966973691L;
		/**
		 * 群成员是否还有下页数据
		 */
		@ApiField("has_more")
