...
public class OapiEduTextbookMetadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3496226567615685396L;
	...
	public static class TextbookMetadataDTO extends TaobaoObject {
		private static final long serialVersionUID = 3522588565478512127L;
		/**
		 * 教材id
		 */
		@ApiField("id")
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7271928349195676798L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
