...
public class OapiCalendarListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5355345142252661616L;
	...
	public static class Attendees extends TaobaoObject {
		private static final long serialVersionUID = 6252783659547946263L;
		/**
		 * 展示姓名
		 */
	...
	public static class User extends TaobaoObject {
		private static final long serialVersionUID = 8719332196353668444L;
		/**
		 * 展示姓名
		 */
		@ApiField("display_name")
	...
	public static class DateTime extends TaobaoObject {
		private static final long serialVersionUID = 3892979634755425127L;
		/**
	...
	public static class Items extends TaobaoObject {
		private static final long serialVersionUID = 8787127529822441769L;
		/**
		 * 参与者,考虑性能问题，该字段不向外透出
		 */
	...
	public static class OpenCalendarListResponse extends TaobaoObject {
		private static final long serialVersionUID = 7175327125779235316L;
		/**
		 * 日程的实体
		 */
		@ApiListField("items")
