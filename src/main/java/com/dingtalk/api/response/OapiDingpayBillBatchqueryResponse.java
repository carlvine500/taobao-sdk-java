...
public class OapiDingpayBillBatchqueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3466839454921524528L;
	...
	public static class DingPayBillOpenBo extends TaobaoObject {
		private static final long serialVersionUID = 8583313125911483818L;
		/**
		 * 金额（单位：分）
		 */
		@ApiField("amount")
	...
	public static class BillBatchQueryOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 6525884725441486847L;
		/**
		 * billList
		 */
