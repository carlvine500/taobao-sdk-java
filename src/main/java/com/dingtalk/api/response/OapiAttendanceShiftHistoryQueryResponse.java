...
public class OapiAttendanceShiftHistoryQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7338638456459834299L;
	...
	public static class TopShiftSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 6548321339769858514L;
		/**
		 * 该班次对应的出勤天数
		 */
	...
	public static class TopPunchVo extends TaobaoObject {
		private static final long serialVersionUID = 5331959227549573589L;
		/**
		 * 是否跨天
		 */
		@ApiField("across")
	...
	public static class TopRestVo extends TaobaoObject {
		private static final long serialVersionUID = 8812941546432671267L;
		/**
		 * 是否跨天
		 */
		@ApiField("across")
	...
	public static class TopSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 5536384866329192386L;
		/**
		 * id
		 */
		@ApiField("id")
	...
	public static class TopShiftVo extends TaobaoObject {
		private static final long serialVersionUID = 4862751111155644258L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
