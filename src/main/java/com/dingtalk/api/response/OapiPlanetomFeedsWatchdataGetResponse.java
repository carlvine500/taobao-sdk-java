...
public class OapiPlanetomFeedsWatchdataGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4391793682677758427L;
	...
	public static class OpenFeedWatchDetailModel extends TaobaoObject {
		private static final long serialVersionUID = 5682537462873557994L;
		/**
		 * 观看直播时长（秒）
		 */
	...
	public static class OpenFeedWatchDetailRspModel extends TaobaoObject {
		private static final long serialVersionUID = 5762678395746462449L;
		/**
		 * 是否还有数据没返回(0还有1没有)
		 */
		@ApiField("has_finish")
