...
public class OapiLiveGroupliveViewrecordResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5854631655687886721L;
	...
	public static class UserViewRecordDetailModelList extends TaobaoObject {
		private static final long serialVersionUID = 4696351794291837134L;
		/**
		 * 开始观看时间戳
		 */
	...
	public static class QueryLiveViewRecordDetail extends TaobaoObject {
		private static final long serialVersionUID = 4472462712852625771L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
