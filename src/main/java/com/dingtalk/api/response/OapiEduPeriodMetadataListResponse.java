...
public class OapiEduPeriodMetadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1789461768485361937L;
	...
	public static class PeriodMetadataDTO extends TaobaoObject {
		private static final long serialVersionUID = 8146351894871491363L;
		/**
		 * 区域编码
		 */
		@ApiField("area_code")
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 3318599293417715529L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
