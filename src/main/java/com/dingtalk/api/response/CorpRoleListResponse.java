...
public class CorpRoleListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8495188792288262825L;
	...
	public static class Roles extends TaobaoObject {
		private static final long serialVersionUID = 3894776878127347839L;
		/**
		 * 角色ID
		 */
		@ApiField("id")
	...
	public static class RoleGroups extends TaobaoObject {
		private static final long serialVersionUID = 8625555786149461559L;
		/**
		 * 角色分组名称
		 */
		@ApiField("group_name")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 8568862239862494623L;
		/**
		 * 分页是否还有数据
		 */
		@ApiField("has_more")
