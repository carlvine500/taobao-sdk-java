...
public class OapiRetailSellerOrgdetailQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3717547935317456396L;
	...
	public static class ShopEmpDto extends TaobaoObject {
		private static final long serialVersionUID = 7886324915326636242L;
		/**
		 * 主子账号
		 */
		@ApiField("emp_type")
	...
	public static class SellerDto extends TaobaoObject {
		private static final long serialVersionUID = 3783976373633852158L;
		/**
		 * 卖家ID
		 */
		@ApiField("seller_id")
	...
	public static class OrgDto extends TaobaoObject {
		private static final long serialVersionUID = 2324676319231851217L;
		/**
		 * 组织绑定卖家List
		 */
