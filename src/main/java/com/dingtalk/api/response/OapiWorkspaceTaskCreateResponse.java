...
public class OapiWorkspaceTaskCreateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1421882213689674393L;
	...
	public static class TaskSystemProperty extends TaobaoObject {
		private static final long serialVersionUID = 8523573695712361171L;
		/**
		 * APP 跳转连接
		 */
		@ApiField("appUrl")
	...
	public static class TaskExtension extends TaobaoObject {
		private static final long serialVersionUID = 3575322569165647648L;
		/**
		 * 评论数量
		 */
	...
	public static class Task extends TaobaoObject {
		private static final long serialVersionUID = 8725735868832824812L;
		/**
		 * 归属企业id
		 */
