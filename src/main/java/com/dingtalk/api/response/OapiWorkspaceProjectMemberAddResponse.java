...
public class OapiWorkspaceProjectMemberAddResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8489458469686751624L;
	...
	public static class OpenTagDto extends TaobaoObject {
		private static final long serialVersionUID = 3544777985433383998L;
		/**
		 * 角色的code
		 */
		@ApiField("code")
	...
	public static class OpenProjectMemberDto extends TaobaoObject {
		private static final long serialVersionUID = 8395196996751887615L;
		/**
		 * 组织id
		 */
		@ApiField("corp_id")
