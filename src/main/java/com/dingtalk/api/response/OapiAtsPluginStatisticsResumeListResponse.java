...
public class OapiAtsPluginStatisticsResumeListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1131295485443727271L;
	...
	public static class TopResumeStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 5712741578568364379L;
		/**
		 * 招聘业务标识
		 */
		@ApiField("biz_code")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 8187975424586969685L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
