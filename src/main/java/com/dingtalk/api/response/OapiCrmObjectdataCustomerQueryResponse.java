...
public class OapiCrmObjectdataCustomerQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4523143548751179246L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 7655738921369137859L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class Values extends TaobaoObject {
		private static final long serialVersionUID = 2176367922572321453L;
		/**
		 * 创建记录的用户昵称
		 */
	...
	public static class IterablePage extends TaobaoObject {
		private static final long serialVersionUID = 3881982886757868153L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
