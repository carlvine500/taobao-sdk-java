...
public class OapiWikiRepoListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4775913494971949757L;
	...
	public static class OpenRepoVo extends TaobaoObject {
		private static final long serialVersionUID = 6634258698722126557L;
		/**
		 * 知识库的描述
		 */
		@ApiField("desc")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 7481424774642728329L;
		/**
		 * 知识本列表
		 */
		@ApiListField("data")
