...
public class OapiCustomerserviceActionQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1739416599638577695L;
	...
	public static class TicketFieldDto extends TaobaoObject {
		private static final long serialVersionUID = 4158597325755265426L;
		/**
		 * 标签名
		 */
	...
	public static class TicketActionDto extends TaobaoObject {
		private static final long serialVersionUID = 4616654119921845627L;
		/**
		 * 动作表单字段列表
		 */
	...
	public static class PageQueryCursorResult extends TaobaoObject {
		private static final long serialVersionUID = 1173798376738745693L;
		/**
		 * 动作列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 3155929438364783774L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
