...
public class OapiWorkbenchShortcutListbypagingResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1411511953331371241L;
	...
	public static class IsvOrgShortcutDTO extends TaobaoObject {
		private static final long serialVersionUID = 8277312891655755616L;
		/**
		 * 业务单号,系统间交互唯一流水号
		 */
		@ApiField("biz_no")
	...
	public static class IsvOrgShortcutListDTO extends TaobaoObject {
		private static final long serialVersionUID = 4724623795728845231L;
		/**
		 * 企业下指定应用已添加快捷方式列表
		 */
