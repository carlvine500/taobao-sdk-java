...
public class OapiAppstoreInternalUnfinishedorderListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8181955714517228842L;
	...
	public static class InAppGoodsOrderVO extends TaobaoObject {
		private static final long serialVersionUID = 5457917766151779784L;
		/**
		 * 订单号
		 */
	...
	public static class PageModel extends TaobaoObject {
		private static final long serialVersionUID = 8562994978589733213L;
		/**
		 * 订单信息列表
		 */
		@ApiListField("items")
