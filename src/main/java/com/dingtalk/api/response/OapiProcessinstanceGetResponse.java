...
public class OapiProcessinstanceGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3875596463233241417L;
	...
	public static class Attachment extends TaobaoObject {
		private static final long serialVersionUID = 7524789389528814148L;
		/**
		 * id
		 */
		@ApiField("file_id")
	...
	public static class OperationRecordsVo extends TaobaoObject {
		private static final long serialVersionUID = 7484852657724956948L;
		/**
		 * 评论附件
		 */
	...
	public static class TaskTopVo extends TaobaoObject {
		private static final long serialVersionUID = 3784736617293375362L;
		/**
		 * 节点id
		 */
	...
	public static class FormComponentValueVo extends TaobaoObject {
		private static final long serialVersionUID = 7164293589336539527L;
		/**
		 * 组件类型
		 */
	...
	public static class ProcessInstanceTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2138452263462752997L;
		/**
		 * 审批人
		 */
