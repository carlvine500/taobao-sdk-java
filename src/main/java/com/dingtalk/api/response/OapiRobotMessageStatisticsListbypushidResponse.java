...
public class OapiRobotMessageStatisticsListbypushidResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1221499973286125565L;
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 1265616774413839991L;
		/**
		 * 当前页数
		 */
	...
	public static class MsgStatByPushIdResVo extends TaobaoObject {
		private static final long serialVersionUID = 4636313779795663391L;
		/**
		 * 群Id
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 7495772723699275628L;
		/**
		 * list
		 */
		@ApiListField("list")
