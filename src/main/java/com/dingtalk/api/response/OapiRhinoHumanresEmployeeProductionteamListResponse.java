...
public class OapiRhinoHumanresEmployeeProductionteamListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1139957681726298529L;
	...
	public static class ProductionTeamList extends TaobaoObject {
		private static final long serialVersionUID = 5273147914292837137L;
		/**
		 * 生产组业务ID
		 */
		@ApiField("biz_id")
	...
	public static class Model extends TaobaoObject {
		private static final long serialVersionUID = 5717699225449316823L;
		/**
		 * 部门邮箱
		 */
		@ApiField("bu_mail")
