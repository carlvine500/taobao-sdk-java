...
public class OapiAtsJobGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6647976921331737974L;
	...
	public static class JobAddressVO extends TaobaoObject {
		private static final long serialVersionUID = 5774326226588546923L;
		/**
		 * 地点详情
		 */
		@ApiField("detail")
	...
	public static class TopJobPartTimeExtDataVo extends TaobaoObject {
		private static final long serialVersionUID = 1418689246943933946L;
		/**
		 * 兼职联系方式
		 */
	...
	public static class JobSimpleVO extends TaobaoObject {
		private static final long serialVersionUID = 4377595333179682572L;
		/**
		 * 职位地址详情
		 */
		@ApiField("address")
