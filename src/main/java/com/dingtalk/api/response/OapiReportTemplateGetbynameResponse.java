...
public class OapiReportTemplateGetbynameResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8754438719768862966L;
	...
	public static class DefaultReceivers extends TaobaoObject {
		private static final long serialVersionUID = 8476225656187279122L;
		/**
		 * 默认接收人名称
		 */
		@ApiField("user_name")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 5243227531218661436L;
		/**
		 * 模板字段名称
		 */
		@ApiField("field_name")
	...
	public static class BaseConversationVo extends TaobaoObject {
		private static final long serialVersionUID = 6351623891293982882L;
		/**
		 * 默认接收群id
		 */
	...
	public static class ReportTemplateResponseVo extends TaobaoObject {
		private static final long serialVersionUID = 5747283694533777467L;
		/**
		 * 默认接收群
		 */
