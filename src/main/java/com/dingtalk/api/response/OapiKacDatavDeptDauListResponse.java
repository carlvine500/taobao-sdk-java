...
public class OapiKacDatavDeptDauListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3378669948689723214L;
	...
	public static class DeptDauSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 5385483921881286981L;
		/**
		 * 钉钉app端登录人数
		 */
	...
	public static class DeptDauSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 7824485693213654423L;
		/**
		 * 数据列表
		 */
		@ApiListField("data")
