...
public class OapiWorkspaceUpdateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3219831943279164174L;
	...
	public static class OpenTagDto extends TaobaoObject {
		private static final long serialVersionUID = 8454216738891813535L;
		/**
		 * 角色code
		 */
		@ApiField("code")
	...
	public static class OpenMemberDto extends TaobaoObject {
		private static final long serialVersionUID = 5133375528952856736L;
		/**
		 * 项目corpid
		 */
		@ApiField("corp_id")
	...
	public static class OpenWorkspaceDto extends TaobaoObject {
		private static final long serialVersionUID = 7545653127117387392L;
		/**
		 * 创建时间
		 */
