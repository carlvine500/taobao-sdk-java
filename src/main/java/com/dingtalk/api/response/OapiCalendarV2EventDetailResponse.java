...
public class OapiCalendarV2EventDetailResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2485981627457165158L;
	...
	public static class Attendee extends TaobaoObject {
		private static final long serialVersionUID = 5472696488172169552L;
		/**
		 * 员工工号
		 */
		@ApiField("userid")
	...
	public static class DateTime extends TaobaoObject {
		private static final long serialVersionUID = 4359893262381111737L;
		/**
	...
	public static class OpenCalendarReminderVo extends TaobaoObject {
		private static final long serialVersionUID = 6827363382926775169L;
		/**
		 * 提醒方式.app表示应用内提醒
		 */
		@ApiField("method")
	...
	public static class LocationVo extends TaobaoObject {
		private static final long serialVersionUID = 7772557997365768157L;
		/**
		 * 经度
		 */
		@ApiField("latitude")
	...
	public static class Event extends TaobaoObject {
		private static final long serialVersionUID = 3568653387992229787L;
		/**
		 * 日程参与者
		 */
