...
public class OapiCollectionFormListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2279825496781341449L;
	...
	public static class FormSchemaSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 4723269243677139937L;
		/**
		 * 表单类型
		 */
		@ApiField("biz_type")
	...
	public static class FormSchemaResponse extends TaobaoObject {
		private static final long serialVersionUID = 3391754359157545189L;
		/**
		 * 创建人
		 */
		@ApiField("creator")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 5268774224482824517L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
