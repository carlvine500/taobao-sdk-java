...
public class OapiCrmObjectmetaDescribeResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8873271342291932429L;
	...
	public static class SelectOptions extends TaobaoObject {
		private static final long serialVersionUID = 3345468439247851678L;
		/**
		 * 选项key
		 */
		@ApiField("key")
	...
	public static class ReferenceFields extends TaobaoObject {
		private static final long serialVersionUID = 5279832839366878554L;
		/**
		 * 引用的关联对象字段格式
		 */
		@ApiField("format")
	...
	public static class RollUpSummaryFields extends TaobaoObject {
		private static final long serialVersionUID = 2324523645891374422L;
		/**
		 * 汇总方法
		 */
		@ApiField("aggregator")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 3679452489347838967L;
		/**
		 * 是否自定义字段
		 */
		@ApiField("customized")
	...
	public static class DObject extends TaobaoObject {
		private static final long serialVersionUID = 2894273972237348744L;
		/**
		 * 是否自定义对象
		 */
		@ApiField("customized")
