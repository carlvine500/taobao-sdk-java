...
public class OapiKacDatavVideoliveDetailListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6448424566644651771L;
	...
	public static class VideoLiveDetailVo extends TaobaoObject {
		private static final long serialVersionUID = 3441116112537787868L;
		/**
		 * 直播群cid
		 */
		@ApiField("cid")
	...
	public static class VideoLiveDetailResponse extends TaobaoObject {
		private static final long serialVersionUID = 4159239384819384735L;
		/**
		 * 数据明细列表
		 */
		@ApiListField("data")
