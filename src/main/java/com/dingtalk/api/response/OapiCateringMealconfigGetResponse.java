...
public class OapiCateringMealconfigGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6692998911527147794L;
	...
	public static class Mealitemlist extends TaobaoObject {
		private static final long serialVersionUID = 3812413926327344348L;
		/**
		 * 送达时间 HH:mm
		 */
	...
	public static class Addressvos extends TaobaoObject {
		private static final long serialVersionUID = 1754949535446136125L;
		/**
		 * 缩略地址，可为空
		 */
		@ApiField("address")
	...
	public static class GroupMealSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 7168284335645676791L;
		/**
		 * 缩略地址，可为空
		 */
		@ApiField("address")
