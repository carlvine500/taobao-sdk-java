...
public class OapiPbpInstanceGroupMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4866192526156131776L;
	...
	public static class PositionVo extends TaobaoObject {
		private static final long serialVersionUID = 7328991247513743813L;
		/**
		 * 成员id，根据类型不同表示不同
		 */
		@ApiField("member_id")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 5716782374414784235L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
