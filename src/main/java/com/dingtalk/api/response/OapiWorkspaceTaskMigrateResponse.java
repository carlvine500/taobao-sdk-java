...
public class OapiWorkspaceTaskMigrateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8664767295257873556L;
	...
	public static class TaskSystemProperty extends TaobaoObject {
		private static final long serialVersionUID = 2113669982164948786L;
		/**
		 * APP 跳转链接
		 */
		@ApiField("appUrl")
	...
	public static class TaskExtension extends TaobaoObject {
		private static final long serialVersionUID = 2235147133135143387L;
		/**
		 * 评论数量
		 */
	...
	public static class Task extends TaobaoObject {
		private static final long serialVersionUID = 4259259768328211665L;
		/**
		 * 归属企业id
		 */
