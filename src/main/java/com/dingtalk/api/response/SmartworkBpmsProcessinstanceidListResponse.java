...
public class SmartworkBpmsProcessinstanceidListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2287221329336153393L;
	...
	public static class ProcessInstanceTopVo extends TaobaoObject {
		private static final long serialVersionUID = 3287699211611264196L;
		/**
		 * 审批实例id
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 8329363295381737376L;
		/**
		 * list
		 */
		@ApiListField("list")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 1617363244536232637L;
		/**
		 * 错误码
		 */
