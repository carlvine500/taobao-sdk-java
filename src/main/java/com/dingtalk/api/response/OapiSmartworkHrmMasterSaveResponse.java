...
public class OapiSmartworkHrmMasterSaveResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7673863883786376475L;
	...
	public static class Failresult extends TaobaoObject {
		private static final long serialVersionUID = 5853385528247116644L;
		/**
		 * 业务流水唯一标识，和入参一致
		 */
		@ApiField("biz_uk")
	...
	public static class IntegrateBatchResultVO extends TaobaoObject {
		private static final long serialVersionUID = 4794888777386779592L;
		/**
		 * 是否全部保存成功
		 */
