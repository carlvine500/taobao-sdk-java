...
public class OapiKacDatavVideoliveViewerListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4129592611128235444L;
	...
	public static class GroupLiveViewer extends TaobaoObject {
		private static final long serialVersionUID = 8182936181983728926L;
		/**
		 * 观看直播时长（毫秒）
		 */
	...
	public static class GroupLiveViewerPageResult extends TaobaoObject {
		private static final long serialVersionUID = 4421539496515868982L;
		/**
		 * 列表数据项
		 */
		@ApiListField("data")
