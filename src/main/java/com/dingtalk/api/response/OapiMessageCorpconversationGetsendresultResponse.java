...
public class OapiMessageCorpconversationGetsendresultResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3553974425339556841L;
	...
	public static class SendForbiddenModel extends TaobaoObject {
		private static final long serialVersionUID = 5456672878471668675L;
		/**
		 * 流控code
		 */
		@ApiField("code")
	...
	public static class AsyncSendResult extends TaobaoObject {
		private static final long serialVersionUID = 3149983617585795152L;
		/**
		 * 发送失败的用户id
		 */
