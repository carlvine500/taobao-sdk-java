...
public class OapiCrmObjectmetaFollowrecordDescribeResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7535943498541224189L;
	...
	public static class SelectOptions extends TaobaoObject {
		private static final long serialVersionUID = 4414215948456467877L;
		/**
		 * 选项key
		 */
		@ApiField("key")
	...
	public static class ReferenceFields extends TaobaoObject {
		private static final long serialVersionUID = 8788374925516384761L;
		/**
		 * 引用的关联对象字段格式
		 */
		@ApiField("format")
	...
	public static class RollUpSummaryFields extends TaobaoObject {
		private static final long serialVersionUID = 7443958475155861487L;
		/**
		 * 汇总方法
		 */
		@ApiField("aggregator")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 3137617899683247357L;
		/**
		 * 是否自定义字段
		 */
		@ApiField("customized")
	...
	public static class DObject extends TaobaoObject {
		private static final long serialVersionUID = 4154125169787734273L;
		/**
		 * 是否自定义对象
		 */
		@ApiField("customized")
