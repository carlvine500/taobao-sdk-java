...
public class OapiEduCourseListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7453165475527252716L;
	...
	public static class Classrooms extends TaobaoObject {
		private static final long serialVersionUID = 3475631778779891176L;
		/**
		 * 课堂交互信息
		 */
	...
	public static class CourseVO extends TaobaoObject {
		private static final long serialVersionUID = 1784744932635716687L;
		/**
		 * 业务唯一键
		 */
		@ApiField("biz_key")
	...
	public static class ListCourseResponse extends TaobaoObject {
		private static final long serialVersionUID = 1839165366531672693L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
