...
public class OapiSmartworkHrmEmployeeListdimissionResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2265658197991113389L;
	...
	public static class EmpDeptVO extends TaobaoObject {
		private static final long serialVersionUID = 3337273644413249797L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class EmpDimissionInfoVo extends TaobaoObject {
		private static final long serialVersionUID = 2539512391743848498L;
		/**
		 * 离职部门列表
		 */
