...
public class OapiWorkspaceAuditlogListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3424573663194972699L;
	...
	public static class EventAuditLogDto extends TaobaoObject {
		private static final long serialVersionUID = 2386679419686982744L;
		/**
		 * 操作类型
		 */
		@ApiField("action")
	...
	public static class OpenAuditLogDto extends TaobaoObject {
		private static final long serialVersionUID = 4454621427613393175L;
		/**
		 * 记录列表
		 */
