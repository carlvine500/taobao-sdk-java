...
public class OapiAttendanceGroupPositionsAddResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3728457472816438325L;
	...
	public static class Position extends TaobaoObject {
		private static final long serialVersionUID = 4229477192265348672L;
		/**
		 * 地址描述
		 */
		@ApiField("address")
	...
	public static class ErrorInfo extends TaobaoObject {
		private static final long serialVersionUID = 3519888841236182968L;
		/**
		 * 错误码
		 */
		@ApiField("code")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 8588275784499995678L;
		/**
		 * 错误列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 7759526524686625673L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
