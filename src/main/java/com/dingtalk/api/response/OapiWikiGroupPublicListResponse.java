...
public class OapiWikiGroupPublicListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4527485981224922896L;
	...
	public static class OpenGroupVO extends TaobaoObject {
		private static final long serialVersionUID = 1425496754264796881L;
		/**
		 * 知识库的描述
		 */
		@ApiField("desc")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 5589626992255249411L;
		/**
		 * 知识库列表
		 */
		@ApiListField("data")
