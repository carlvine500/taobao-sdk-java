...
public class OapiAlitripBtripHotelOrderSearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4529826182731443969L;
	...
	public static class OpenCostCenterDo extends TaobaoObject {
		private static final long serialVersionUID = 7668882695975881833L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
	...
	public static class OpenInvoiceDo extends TaobaoObject {
		private static final long serialVersionUID = 1246318259488449599L;
		/**
		 * 商旅发票id
		 */
		@ApiField("id")
	...
	public static class OpenPriceInfo extends TaobaoObject {
		private static final long serialVersionUID = 2567884536138416264L;
		/**
		 * 交易类型
		 */
		@ApiField("category")
	...
	public static class OpenUserAffiliateDo extends TaobaoObject {
		private static final long serialVersionUID = 6474553362783564584L;
		/**
		 * 入住人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenHotelOrderRs extends TaobaoObject {
		private static final long serialVersionUID = 4344789266984183357L;
		/**
		 * 商旅申请单id
		 */
		@ApiField("apply_id")
	...
	public static class PageInfoRs extends TaobaoObject {
		private static final long serialVersionUID = 7271673465565717333L;
		/**
		 * 当前页
		 */
		@ApiField("page")
