...
public class OapiAttendanceVacationQuotaUpdateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4276941257358415877L;
	...
	public static class Quota extends TaobaoObject {
		private static final long serialVersionUID = 7481954284187799498L;
		/**
		 * 假期类型唯一标识
		 */
		@ApiField("leave_code")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 4182642328186981315L;
		/**
		 * 失败记录
		 */
		@ApiField("quota")
