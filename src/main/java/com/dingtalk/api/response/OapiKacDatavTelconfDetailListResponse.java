...
public class OapiKacDatavTelconfDetailListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8394941713744667818L;
	...
	public static class TelConferenceDetailVo extends TaobaoObject {
		private static final long serialVersionUID = 5252754264176577516L;
		/**
		 * 会议id
		 */
		@ApiField("conf_id")
	...
	public static class TelConferenceDetailResponse extends TaobaoObject {
		private static final long serialVersionUID = 4287561216456741297L;
		/**
		 * data
		 */
		@ApiListField("data")
