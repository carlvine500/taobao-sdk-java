...
public class OapiSmartworkHrmEmployeeListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5642762372832937331L;
	...
	public static class EmpFieldVO extends TaobaoObject {
		private static final long serialVersionUID = 2857535657182782745L;
		/**
		 * 字段编码
		 */
		@ApiField("field_code")
	...
	public static class EmpFieldInfoVO extends TaobaoObject {
		private static final long serialVersionUID = 1185559867292912797L;
		/**
		 * 字段信息列表
		 */
