...
public class OapiAttendanceGetupdatedataResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8749236544583738342L;
	...
	public static class AtAttendanceResultForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 5197889568181459884L;
		/**
		 * 打卡类型 上班还是下班
		 */
		@ApiField("check_type")
	...
	public static class AtApproveForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 3425899217947249718L;
		/**
		 * 审批单开始时间
		 */
		@ApiField("begin_time")
	...
	public static class AtAttendanceRecordForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 7728415329331471869L;
		/**
		 * 基本定位精度
		 */
	...
	public static class AtRestTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 7847972488335744256L;
		/**
		 * 休息开始时间
		 */
	...
	public static class AtClassSettingInfoForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 8171838256545149589L;
		/**
		 * restTimeVOList
		 */
	...
	public static class AtCheckInfoForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 4796642356497173749L;
		/**
		 * 审批单列表
		 */
