...
public class OapiCrmObjectmetaCustomerDescribeResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5824225666699723863L;
	...
	public static class SelectOptions extends TaobaoObject {
		private static final long serialVersionUID = 4827694558257938692L;
		/**
		 * 选项key
		 */
		@ApiField("key")
	...
	public static class ReferenceFields extends TaobaoObject {
		private static final long serialVersionUID = 8192441673161883974L;
		/**
		 * 引用的关联对象字段格式
		 */
		@ApiField("format")
	...
	public static class RollUpSummaryFields extends TaobaoObject {
		private static final long serialVersionUID = 4279421495736246943L;
		/**
		 * 汇总方法
		 */
		@ApiField("aggregator")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 6282126879823126369L;
		/**
		 * 是否自定义字段
		 */
		@ApiField("customized")
	...
	public static class DObject extends TaobaoObject {
		private static final long serialVersionUID = 1757949251612418245L;
		/**
		 * 是否自定义对象
		 */
		@ApiField("customized")
