...
public class OapiCollectionInstanceListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1418375159575526424L;
	...
	public static class FormData extends TaobaoObject {
		private static final long serialVersionUID = 5188414463549466372L;
		/**
		 * 表单控件key
		 */
		@ApiField("key")
	...
	public static class FormInstanceResponse extends TaobaoObject {
		private static final long serialVersionUID = 4388764669817672523L;
		/**
		 * 毫秒级时间戳，填表提交时间
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 7773575745332388475L;
		/**
		 * 是否还有下一页
		 */
		@ApiField("has_more")
