...
public class OapiKacOpenliveRecordListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7642568816398369581L;
	...
	public static class ListOpenLiveRecordRspModel extends TaobaoObject {
		private static final long serialVersionUID = 8312813272512219997L;
		/**
		 * 直播ID
		 */
		@ApiField("live_id")
	...
	public static class ResultList extends TaobaoObject {
		private static final long serialVersionUID = 3595498977423825618L;
		/**
		 * 直播总数
		 */
		@ApiField("total_cnt")
