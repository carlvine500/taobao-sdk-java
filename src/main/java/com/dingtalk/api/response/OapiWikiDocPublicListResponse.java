...
public class OapiWikiDocPublicListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8817736595986711595L;
	...
	public static class OpenDocVo extends TaobaoObject {
		private static final long serialVersionUID = 7771542668897744364L;
		/**
		 * 知识页所在知识库id（加密后的值）
		 */
		@ApiField("group_id")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 1465996391998432447L;
		/**
		 * 知识页列表
		 */
		@ApiListField("data")
