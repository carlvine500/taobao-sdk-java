...
public class OapiImpaasGroupQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8256441175277958491L;
	...
	public static class BaseGroupMemberInfo extends TaobaoObject {
		private static final long serialVersionUID = 6655822915841676224L;
		/**
		 * 群主ID，类型由type字段决定
		 */
		@ApiField("id")
	...
	public static class GroupInfo extends TaobaoObject {
		private static final long serialVersionUID = 6671522881651824775L;
		/**
		 * 群ID
		 */
		@ApiField("chatid")
