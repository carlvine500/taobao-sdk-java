...
public class OapiEduCourseParticipantListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5697111629846289326L;
	...
	public static class CourseParticipantVO extends TaobaoObject {
		private static final long serialVersionUID = 7668953317856575126L;
		/**
		 * 参与方的组织CorpId
		 */
	...
	public static class ListCourseParticipantResponse extends TaobaoObject {
		private static final long serialVersionUID = 3117953113584498499L;
		/**
		 * 表示是否还有更多的数据
		 */
		@ApiField("has_more")
