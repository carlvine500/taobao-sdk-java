...
public class OapiHireStatisticsBizflowListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1728242325246895697L;
	...
	public static class TopBizFlowStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 1692533149733676919L;
		/**
		 * 候选人id
		 */
	...
	public static class DdAtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 3294544693267777893L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
