...
public class OapiHrmEmployeeGetdismissionlistResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4721937661243919222L;
	...
	public static class HrmApiDismissionModel extends TaobaoObject {
		private static final long serialVersionUID = 6524639532492831889L;
		/**
		 * 入职时间
		 */
	...
	public static class HrmApiPage extends TaobaoObject {
		private static final long serialVersionUID = 3177762671819979241L;
		/**
		 * 当前页
		 */
		@ApiField("current")
