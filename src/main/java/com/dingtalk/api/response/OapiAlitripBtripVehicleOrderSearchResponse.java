...
public class OapiAlitripBtripVehicleOrderSearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4369869918764292754L;
	...
	public static class OpenPriceInfo extends TaobaoObject {
		private static final long serialVersionUID = 8238516568838986826L;
		/**
	...
	public static class OpenUserAffiliateDo extends TaobaoObject {
		private static final long serialVersionUID = 8574295355327311576L;
		/**
		 * 出行人名称
		 */
		@ApiField("user_name")
	...
	public static class OpenVehicleOrderRs extends TaobaoObject {
		private static final long serialVersionUID = 6391539911939326922L;
		/**
		 * 商旅系统审批单id
		 */
		@ApiField("apply_id")
	...
	public static class PageInfoRs extends TaobaoObject {
		private static final long serialVersionUID = 6779763665418379796L;
		/**
		 * 当前页
		 */
		@ApiField("page")
