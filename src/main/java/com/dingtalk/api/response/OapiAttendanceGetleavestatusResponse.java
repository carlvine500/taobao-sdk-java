...
public class OapiAttendanceGetleavestatusResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3149411113752418783L;
	...
	public static class LeaveStatusVO extends TaobaoObject {
		private static final long serialVersionUID = 1241429896128524988L;
		/**
	...
	public static class LeaveStatusListVO extends TaobaoObject {
		private static final long serialVersionUID = 1883824897441417871L;
		/**
		 * 是否有更多数据
		 */
		@ApiField("has_more")
