...
public class OapiSmartdeviceMeetingroomParticipantListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2419952982528568869L;
	...
	public static class MemeberOpenInfo extends TaobaoObject {
		private static final long serialVersionUID = 1544695481938853226L;
		/**
		 * 参会人userid
		 */
		@ApiField("userid")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 8871785335785193935L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
