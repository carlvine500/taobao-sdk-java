...
public class OapiExtcontactListlabelgroupsResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5526281251153263147L;
	...
	public static class OpenLabel extends TaobaoObject {
		private static final long serialVersionUID = 3358539287861494438L;
		/**
		 * 标签id
		 */
		@ApiField("id")
	...
	public static class OpenLabelGroup extends TaobaoObject {
		private static final long serialVersionUID = 7125598736955194454L;
		/**
		 * 标签组颜色
		 */
		@ApiField("color")
