...
public class OapiEduGuardianListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5423135456758777726L;
	...
	public static class GuardianRespone extends TaobaoObject {
		private static final long serialVersionUID = 1852351859758359992L;
		/**
		 * 家长ID
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 7454795686127522735L;
		/**
		 * 是否存在下一页
		 */
		@ApiField("has_more")
