...
public class OapiAttendanceGroupWifisAddResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2537454483727149645L;
	...
	public static class Wifi extends TaobaoObject {
		private static final long serialVersionUID = 3273433998625919259L;
		/**
		 * 业务方wifiId
		 */
		@ApiField("foreign_id")
	...
	public static class ErrorInfo extends TaobaoObject {
		private static final long serialVersionUID = 3621457549739585255L;
		/**
		 * 错误码
		 */
		@ApiField("code")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 7468196524283937756L;
		/**
		 * 错误列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 2769463318648983157L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
