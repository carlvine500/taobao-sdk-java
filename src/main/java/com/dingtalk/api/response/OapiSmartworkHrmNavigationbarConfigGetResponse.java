...
public class OapiSmartworkHrmNavigationbarConfigGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5581527983118395917L;
	...
	public static class HrmNavBarTreePointLevel5Vo extends TaobaoObject {
		private static final long serialVersionUID = 1149216454662315694L;
		/**
		 * 权限key
		 */
		@ApiField("auth_key")
	...
	public static class HrmNavBarTreePointLevel4Vo extends TaobaoObject {
		private static final long serialVersionUID = 5871793628168397952L;
		/**
		 * 权限key
		 */
		@ApiField("auth_key")
	...
	public static class HrmNavBarTreePointLevel3Vo extends TaobaoObject {
		private static final long serialVersionUID = 2754943368211984128L;
		/**
		 * 权限key
		 */
		@ApiField("auth_key")
	...
	public static class HrmNavBarTreePointLevel2Vo extends TaobaoObject {
		private static final long serialVersionUID = 8719223264526454387L;
		/**
		 * 权限key
		 */
		@ApiField("auth_key")
	...
	public static class HrmNavBarTreePointLevel1Vo extends TaobaoObject {
		private static final long serialVersionUID = 5384745332356262737L;
		/**
		 * 权限key
		 */
		@ApiField("auth_key")
	...
	public static class EmpBaseInfoVo extends TaobaoObject {
		private static final long serialVersionUID = 6874757315767592472L;
		/**
		 * 管理员头像
		 */
		@ApiField("avatar")
	...
	public static class HrmNavigationBarVo extends TaobaoObject {
		private static final long serialVersionUID = 8233711397498417575L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
