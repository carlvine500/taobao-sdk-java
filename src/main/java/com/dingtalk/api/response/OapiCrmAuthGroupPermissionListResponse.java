...
public class OapiCrmAuthGroupPermissionListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5465793847576645681L;
	...
	public static class OperateScope extends TaobaoObject {
		private static final long serialVersionUID = 5675146187885963555L;
		/**
		 * 是否有权限
		 */
		@ApiField("has_auth")
	...
	public static class DeptInfo extends TaobaoObject {
		private static final long serialVersionUID = 3542642249472864292L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class StaffInfo extends TaobaoObject {
		private static final long serialVersionUID = 4368596815373538463L;
		/**
		 * 员工名称
		 */
		@ApiField("name")
	...
	public static class Ext extends TaobaoObject {
		private static final long serialVersionUID = 5114334314715184186L;
		/**
		 * 管理部门信息
		 */
	...
	public static class ManageScope extends TaobaoObject {
		private static final long serialVersionUID = 7231229754479976234L;
		/**
		 * 扩展内容
		 */
		@ApiField("ext")
	...
	public static class AuthObjects extends TaobaoObject {
		private static final long serialVersionUID = 8223784539837338464L;
		/**
		 * 表单名称
		 */
		@ApiField("label")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 7635921191858674772L;
		/**
		 * 权限内容
		 */
