...
public class OapiAlitripBtripTrainCitySuggestResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7643411542517891624L;
	...
	public static class CityVo extends TaobaoObject {
		private static final long serialVersionUID = 8223879658284659842L;
		/**
		 * 城市码
		 */
		@ApiField("code")
	...
	public static class SuggestRs extends TaobaoObject {
		private static final long serialVersionUID = 2816876483456595335L;
		/**
		 * 城市列表
		 */
		@ApiListField("cities")
