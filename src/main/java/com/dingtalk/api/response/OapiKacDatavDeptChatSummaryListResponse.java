...
public class OapiKacDatavDeptChatSummaryListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5117474414681522163L;
	...
	public static class ImDeptSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 4359426231467267723L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class ImDeptSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 8474296524135435343L;
		/**
		 * data
		 */
		@ApiListField("data")
