...
public class OapiCustomerserviceTicketQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7287455474849111921L;
	...
	public static class TicketBaseDto extends TaobaoObject {
		private static final long serialVersionUID = 4757545552161983284L;
		/**
		 * 新建时间
		 */
		@ApiField("gmt_create")
	...
	public static class PageQueryCursorResult extends TaobaoObject {
		private static final long serialVersionUID = 1882678231747456229L;
		/**
		 * 是否有更多数据
		 */
		@ApiField("has_more")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 7186477425586812399L;
		/**
		 * 错误吗
		 */
		@ApiField("errcode")
