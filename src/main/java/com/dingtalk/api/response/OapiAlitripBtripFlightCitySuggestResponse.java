...
public class OapiAlitripBtripFlightCitySuggestResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2491785534236611497L;
	...
	public static class CityVo extends TaobaoObject {
		private static final long serialVersionUID = 6583787334766369552L;
		/**
		 * 三字码
		 */
		@ApiField("code")
	...
	public static class SuggestRs extends TaobaoObject {
		private static final long serialVersionUID = 6453966269961778983L;
		/**
		 * 城市列表
		 */
		@ApiListField("cities")
