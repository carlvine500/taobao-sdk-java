...
public class OapiEduSubjectListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1611799134569156417L;
	...
	public static class SubjectInstanceDTO extends TaobaoObject {
		private static final long serialVersionUID = 8586346872923854864L;
		/**
		 * 学段编码
		 */
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 5776239142776231287L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
