...
public class OapiServiceaccountMenuGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4513149734961279715L;
	...
	public static class MenuSubButtonDTO extends TaobaoObject {
		private static final long serialVersionUID = 1885197296619327716L;
		/**
		 * 菜单绑定的key值
		 */
		@ApiField("key")
	...
	public static class MenuButtonDTO extends TaobaoObject {
		private static final long serialVersionUID = 5624822332967787493L;
		/**
		 * 菜单绑定的key值
		 */
		@ApiField("key")
	...
	public static class MenuConfigDTO extends TaobaoObject {
		private static final long serialVersionUID = 3553582967475144248L;
		/**
		 * 菜单按钮列表
		 */
		@ApiListField("button")
